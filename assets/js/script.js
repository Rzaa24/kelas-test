...
// Dirubah 
const pengirim = "Abim";
const nomorWa = "6282133751840" // awalan nomor 0 harus di awalin 62
const textWa = "Hahahaha"
const pesan = `, aku cuma mau bilang, aku sangat bersyukur ada kamu di hidupku! Thanks banget udah nerima aku apa adanya dan jadi temen yang selalu ada. Kamu bikin hari-hariku jadi lebih seru dan berarti.
Setiap momen bareng kamu itu priceless, dan semua tawa kita bikin semuanya terasa lebih ringan. Jangan pernah cape atau bosen sama aku, ya! Kita bareng-bareng terus sampai kita bisa mencapai masa depan kita. Kamu itu keren banget tauu, dan aku merasa lucky bisa kenal kamu!. Jangan Badmood Lagi yaaa, Kalo misal kamu cape atau baterainya habis saat ada aku, beri aku petunjuk...petunjuknya beritau aku di pesan dibawah yaaa, Sama ada hal yang perlu aku ketahui ga? tentang aku ga boleh apa atau gimana, atur aku agar menjadi orang yang kamu inginkan, aku ingin menjadi lebih baik.... Berikan Jawabanmu di bawah yaaa`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    let txt = `Halo, Kak ${result.value.login} ${pesan}`;
